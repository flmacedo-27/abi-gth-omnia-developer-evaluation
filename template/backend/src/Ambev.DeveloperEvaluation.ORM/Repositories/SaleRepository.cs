...
public class SaleRepository : ISaleRepository
{
    ...
    /// </summary>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>The sale list, empty list otherwise</returns>
    public async Task<List<Sale>> GetAsync(CancellationToken cancellationToken = default)
    {
